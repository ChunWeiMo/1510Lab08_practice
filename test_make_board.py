...
class Test(TestCase):
    ...
    def test_2_by_2_board(self, _):
        ...
        self.assertAlmostEqual(except_board, make_board(2, 2))
    ...
    def test_square_board(self, _):
        ...
        self.assertAlmostEqual(except_board, make_board(3, 3))
    ...
    def test_rows_grater_than_columns_board(self, _):
        ...
        self.assertAlmostEqual(except_board, make_board(4, 3))
    ...
    def test_rows_less_than_columns_board(self, _):
        ...
        self.assertAlmostEqual(except_board, make_board(3, 4))
    ...
    def test_5_kinds_room_board(self, _):
        ...
        self.assertAlmostEqual(except_board, make_board(4, 2))
